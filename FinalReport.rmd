...
The barchart shows that out of the approximately 607 Females who were infected with Covid-19, 32% were given the drug, and 66% were given the placebo.
...
$H_A$ the alternative hypothesis is that the vaccine in fact does make a difference in whether or not a Female contacts Covid-19.  

Therefore we reject the Null Hypothesis.

The Fisher Exact Test odds ratio is 2.05:1, when taking the odds ratio and computing it into a percent of effectiveness by using the formula O/(1+0)*100 you get 67% effectiveness.  
...
The Chi Squared table shows that the P-Value of 0.002273 is so small that it is highly unlikely that the results were by chance.
...
$H_A$ the alternative hypothesis is that the vaccine in fact does make a difference in whether or not a DrugUser contacts Covid-19.  

Therefore we reject the Null Hypothesis.

The Fisher Exact Test odds ratio is 1.83:1, when taking the odds ratio and computing it into a percent of effectiveness by using the formula O/(1+0)*100 you get 60% effectiveness.  
...
This Barchart shows that out of approximately 116 LGBTQ who were infected with Covid-19, 70% were given the drug, and 29% were given the placebo.
...
The table shows that about 116 LGBTQ were infected with Covid-19 out of approximately 2,040 LGBTQ in the study. The table also shows that 70% of LGBTQ who receive the drug got Covid-19, and 29% of the LGBTQ who got the placebo contracted Covid-19. Lastly the table shows that LGBTQ who got the vaccine were about 29% more likely to contract Covid-19, this shows that the vaccine is not effective for the LGBTQ population.
...
The Chi Squared table shows that the P-Value of 0.0000057 is so small that it is highly unlikely that the results were by chance.  
...
$H_A$ the alternative hypothesis is that the vaccine in fact does make a difference in whether or not a LGBTQ contacts Covid-19.  

Therefore we reject the Null Hypothesis.

The Fisher Exact Test odds ratio is 0.40:1, when taking the odds ratio and computing it into a percent of effectiveness by using the formula O/(1+0)*100 you get 29% effectiveness. 
...
When looking at the 4 populations, we found that the two populations that had the highest rate of effectiveness were Females at 67% and the DrugUsers at 60%. Both the Male population and the LGBTQ populations showed that the vaccine was not beneficial to them and were ineffective in protecting them from contracting Covid-19, the Males had a 40% effectiveness, while the LGBTQ had 29% effectiveness, which is not all effective. 
